...
!function(e,t){if("function"==typeof define&&define.amd)define(["exports"],t);else if("undefined"!=typeof exports)t(exports);else{var o={};t(o),e.bodyScrollLock=o}}(this,function(e){"use strict";function r(e){if(Array.isArray(e)){for(var t=0,o=Array(e.length);t<e.length;t++)o[t]=e[t];return o}return Array.from(e)}Object.defineProperty(e,"__esModule",{value:!0});var l=!1;if("undefined"!=typeof window){var t={get passive(){l=!0}};window.addEventListener("testPassive",null,t),window.removeEventListener("testPassive",null,t)}var d="undefined"!=typeof window&&window.navigator&&window.navigator.platform&&/iP(ad|hone|od)/.test(window.navigator.platform),c=[],u=!1,a=-1,s=void 0,v=void 0,f=function(t){return c.some(function(e){return!(!e.options.allowTouchMove||!e.options.allowTouchMove(t))})},m=function(e){var t=e||window.event;return!!f(t.target)||1<t.touches.length||(t.preventDefault&&t.preventDefault(),!1)},o=function(){setTimeout(function(){void 0!==v&&(document.body.style.paddingRight=v,v=void 0),void 0!==s&&(document.body.style.overflow=s,s=void 0)})};e.disableBodyScroll=function(i,e){if(d){if(!i)return void console.error("disableBodyScroll unsuccessful - targetElement must be provided when calling disableBodyScroll on IOS devices.");if(i&&!c.some(function(e){return e.targetElement===i})){var t={targetElement:i,options:e||{}};c=[].concat(r(c),[t]),i.ontouchstart=function(e){1===e.targetTouches.length&&(a=e.targetTouches[0].clientY)},i.ontouchmove=function(e){var t,o,n,r;1===e.targetTouches.length&&(o=i,r=(t=e).targetTouches[0].clientY-a,!f(t.target)&&(o&&0===o.scrollTop&&0<r?m(t):(n=o)&&n.scrollHeight-n.scrollTop<=n.clientHeight&&r<0?m(t):t.stopPropagation()))},u||(document.addEventListener("touchmove",m,l?{passive:!1}:void 0),u=!0)}}else{n=e,setTimeout(function(){if(void 0===v){var e=!!n&&!0===n.reserveScrollBarGap,t=window.innerWidth-document.documentElement.clientWidth;e&&0<t&&(v=document.body.style.paddingRight,document.body.style.paddingRight=t+"px")}void 0===s&&(s=document.body.style.overflow,document.body.style.overflow="hidden")});var o={targetElement:i,options:e||{}};c=[].concat(r(c),[o])}var n},e.clearAllBodyScrollLocks=function(){d?(c.forEach(function(e){e.targetElement.ontouchstart=null,e.targetElement.ontouchmove=null}),u&&(document.removeEventListener("touchmove",m,l?{passive:!1}:void 0),u=!1),c=[],a=-1):(o(),c=[])},e.enableBodyScroll=function(t){if(d){if(!t)return void console.error("enableBodyScroll unsuccessful - targetElement must be provided when calling enableBodyScroll on IOS devices.");t.ontouchstart=null,t.ontouchmove=null,c=c.filter(function(e){return e.targetElement!==t}),u&&0===c.length&&(document.removeEventListener("touchmove",m,l?{passive:!1}:void 0),u=!1)}else(c=c.filter(function(e){return e.targetElement!==t})).length||o()}});
!function(e,r){"function"==typeof define&&define.amd?define(["ScrollMagic"],r):r("object"==typeof exports?require("scrollmagic"):e.ScrollMagic||e.jQuery&&e.jQuery.ScrollMagic)}(this,function(i){"use strict";var o="0.85em",n="9999",v=i._util,h=0;i.Scene.extend(function(){var r,t=this;t.addIndicators=function(e){if(!r){e=v.extend({},{name:"",indent:0,parent:void 0,colorStart:"green",colorEnd:"red",colorTrigger:"blue"},e),h++,r=new s(t,e),t.on("add.plugin_addIndicators",r.add),t.on("remove.plugin_addIndicators",r.remove),t.on("destroy.plugin_addIndicators",t.removeIndicators),t.controller()&&r.add()}return t},t.removeIndicators=function(){return r&&(r.remove(),this.off("*.plugin_addIndicators"),r=void 0),t}}),i.Controller.addOption("addIndicators",!1),i.Controller.extend(function(){var c=this,e=c.info(),l=e.container,f=e.isDocument,m=e.vertical,h={groups:[]};this._indicators=h;var r=function(){h.updateBoundsPositions()},t=function(){h.updateTriggerGroupPositions()};return l.addEventListener("resize",t),f||(window.addEventListener("resize",t),window.addEventListener("scroll",t)),l.addEventListener("resize",r),l.addEventListener("scroll",r),this._indicators.updateBoundsPositions=function(e){for(var r,t,i,o=e?[v.extend({},e.triggerGroup,{members:[e]})]:h.groups,n=o.length,s={},d=m?"left":"top",a=m?"width":"height",g=m?v.get.scrollLeft(l)+v.get.width(l)-15:v.get.scrollTop(l)+v.get.height(l)-15;n--;)for(r=(i=o[n]).members.length,t=v.get[a](i.element.firstChild);r--;)s[d]=g-t,v.css(i.members[r].bounds,s)},this._indicators.updateTriggerGroupPositions=function(e){for(var r,t,i,o,n=e?[e]:h.groups,s=n.length,d=f?document.body:l,a=f?{top:0,left:0}:v.get.offset(d,!0),g=m?v.get.width(l)-15:v.get.height(l)-15,p=m?"width":"height",u=m?"Y":"X";s--;)t=(r=n[s]).element,i=r.triggerHook*c.info("size"),o=v.get[p](t.firstChild.firstChild)<i?"translate"+u+"(-100%)":"",v.css(t,{top:a.top+(m?i:g-r.members[0].options.indent),left:a.left+(m?g-r.members[0].options.indent:i)}),v.css(t.firstChild.firstChild,{"-ms-transform":o,"-webkit-transform":o,transform:o})},this._indicators.updateTriggerGroupLabel=function(e){var r="trigger"+(1<e.members.length?"":" "+e.members[0].options.name),t=e.element.firstChild.firstChild;t.textContent!==r&&(t.textContent=r,m&&h.updateBoundsPositions())},this.addScene=function(e){this._options.addIndicators&&e instanceof i.Scene&&e.controller()===c&&e.addIndicators(),this.$super.addScene.apply(this,arguments)},this.destroy=function(){l.removeEventListener("resize",t),f||(window.removeEventListener("resize",t),window.removeEventListener("scroll",t)),l.removeEventListener("resize",r),l.removeEventListener("scroll",r),this.$super.destroy.apply(this,arguments)},c});var s=function(o,n){var s,d,a=this,r=b.bounds(),t=b.start(n.colorStart),i=b.end(n.colorEnd),g=n.parent&&v.get.elements(n.parent)[0];n.name=n.name||h,t.firstChild.textContent+=" "+n.name,i.textContent+=" "+n.name,r.appendChild(t),r.appendChild(i),a.options=n,a.bounds=r,a.triggerGroup=void 0,this.add=function(){d=o.controller(),s=d.info("vertical");var e=d.info("isDocument");g||(g=e?document.body:d.info("container")),e||"static"!==v.css(g,"position")||v.css(g,{position:"relative"}),o.on("change.plugin_addIndicators",u),o.on("shift.plugin_addIndicators",p),m(),l(),setTimeout(function(){d._indicators.updateBoundsPositions(a)},0)},this.remove=function(){if(a.triggerGroup){if(o.off("change.plugin_addIndicators",u),o.off("shift.plugin_addIndicators",p),1<a.triggerGroup.members.length){var e=a.triggerGroup;e.members.splice(e.members.indexOf(a),1),d._indicators.updateTriggerGroupLabel(e),d._indicators.updateTriggerGroupPositions(e),a.triggerGroup=void 0}else f();c()}};var p=function(){l()},u=function(e){"triggerHook"===e.what&&m()},c=function(){r.parentNode.removeChild(r)},l=function(){r.parentNode!==g&&function(){var e=d.info("vertical");v.css(t.firstChild,{"border-bottom-width":e?1:0,"border-right-width":e?0:1,bottom:e?-1:n.indent,right:e?n.indent:-1,padding:e?"0 8px":"2px 4px"}),v.css(i,{"border-top-width":e?1:0,"border-left-width":e?0:1,top:e?"100%":"",right:e?n.indent:"",bottom:e?"":n.indent,left:e?"":"100%",padding:e?"0 8px":"2px 4px"}),g.appendChild(r)}();var e={};e[s?"top":"left"]=o.triggerPosition(),e[s?"height":"width"]=o.duration(),v.css(r,e),v.css(i,{display:0<o.duration()?"":"none"})},f=function(){d._indicators.groups.splice(d._indicators.groups.indexOf(a.triggerGroup),1),a.triggerGroup.element.parentNode.removeChild(a.triggerGroup.element),a.triggerGroup=void 0},m=function(){var e=o.triggerHook();if(!(a.triggerGroup&&Math.abs(a.triggerGroup.triggerHook-e)<1e-4)){for(var r,t=d._indicators.groups,i=t.length;i--;)if(r=t[i],Math.abs(r.triggerHook-e)<1e-4)return a.triggerGroup&&(1===a.triggerGroup.members.length?f():(a.triggerGroup.members.splice(a.triggerGroup.members.indexOf(a),1),d._indicators.updateTriggerGroupLabel(a.triggerGroup),d._indicators.updateTriggerGroupPositions(a.triggerGroup))),r.members.push(a),a.triggerGroup=r,void d._indicators.updateTriggerGroupLabel(r);if(a.triggerGroup){if(1===a.triggerGroup.members.length)return a.triggerGroup.triggerHook=e,void d._indicators.updateTriggerGroupPositions(a.triggerGroup);a.triggerGroup.members.splice(a.triggerGroup.members.indexOf(a),1),d._indicators.updateTriggerGroupLabel(a.triggerGroup),d._indicators.updateTriggerGroupPositions(a.triggerGroup),a.triggerGroup=void 0}!function(){var e=b.trigger(n.colorTrigger),r={};r[s?"right":"bottom"]=0,r[s?"border-top-width":"border-left-width"]=1,v.css(e.firstChild,r),v.css(e.firstChild.firstChild,{padding:s?"0 8px 3px 8px":"3px 4px"}),document.body.appendChild(e);var t={triggerHook:o.triggerHook(),element:e,members:[a]};d._indicators.groups.push(t),a.triggerGroup=t,d._indicators.updateTriggerGroupLabel(t),d._indicators.updateTriggerGroupPositions(t)}()}}},b={start:function(e){var r=document.createElement("div");r.textContent="start",v.css(r,{position:"absolute",overflow:"visible","border-width":0,"border-style":"solid",color:e,"border-color":e});var t=document.createElement("div");return v.css(t,{position:"absolute",overflow:"visible",width:0,height:0}),t.appendChild(r),t},end:function(e){var r=document.createElement("div");return r.textContent="end",v.css(r,{position:"absolute",overflow:"visible","border-width":0,"border-style":"solid",color:e,"border-color":e}),r},bounds:function(){var e=document.createElement("div");return v.css(e,{position:"absolute",overflow:"visible","white-space":"nowrap","pointer-events":"none","font-size":o}),e.style.zIndex=n,e},trigger:function(e){var r=document.createElement("div");r.textContent="trigger",v.css(r,{position:"relative"});var t=document.createElement("div");v.css(t,{position:"absolute",overflow:"visible","border-width":0,"border-style":"solid",color:e,"border-color":e}),t.appendChild(r);var i=document.createElement("div");return v.css(i,{position:"fixed",overflow:"visible","white-space":"nowrap","pointer-events":"none","font-size":o}),i.style.zIndex=n,i.appendChild(t),i}}});
...
var Global={init:function(){}};$(document).ready(function(){Global.init()});
var Index=function(){var o,n,i,r,a=document.querySelector("#wrapper"),l=document.querySelector("#zhao-video"),c=document.querySelector("#han-audio"),h=document.querySelector("#tsai-audio"),e=function(){var e=imagesLoaded("#wrapper"),o=0;e.on("always",function(){window.scrollTo(0,0)}),e.on("progress",function(e,a){c.load(),h.load(),l.load();var s,t=e.images.length;o++,s=Math.round(o/t*100),$(".percent span").html(s+"%")}),e.on("done",function(){Timeline=(new TimelineMax).add(function(){m(!0)}).to(".loading",.5,{alpha:0,ease:Power3.easeIn}).set(".loading",{display:"none"}).add(function(){m(!1)})})},s=function(e){var a=$(".speech .party"),s=$(".speech .player"),t=$(".speech .subtitle");Timeline=e?(new TimelineMax).add(function(){m(!0)},.3).to(o,.3,{height:"100%",ease:Power3.easeOut},.3).to(n,.3,{height:"0%",ease:Power3.easeOut},.3).set(t,{display:"flex"},.6).to(s,.3,{alpha:0,ease:Power3.easeOut},.6).set(s,{display:"none"},.9):(new TimelineMax).set(s,{display:"flex",alpha:1},0).set(t,{display:"none"},0).to(a,.3,{height:"50%",ease:Power3.easeOut},0).add(function(){m(!1)},.3)},t=function(e){e?l.play():l.pause()},u=function(){stage1TL=(new TimelineMax).to(".intro",.3,{alpha:0,ease:Power3.easeIn}).set(".intro",{display:"none"}).from(".opinion",.3,{alpha:0,ease:Power3.easeOut}).to(".opinion .talk-1",.1,{className:"+=active"},"talk").to(".opinion .talk-1",.1,{className:"-=active"},"talk+=.2").to(".opinion .talk-2",.1,{className:"+=active"},"talk+=.2").to(".opinion .talk-2",.1,{className:"-=active"},"talk+=.4").to(".opinion .talk-3",.1,{className:"+=active"},"talk+=.4").to(".opinion .talk-3",.1,{className:"-=active"},"talk+=.6").to(".opinion .talk-4",.1,{className:"+=active"},"talk+=.6").to(".opinion .talk-4",.1,{className:"-=active"},"talk+=.8").to(".opinion .talk-5",.1,{className:"+=active"},"talk+=.8").to(".opinion",.3,{alpha:0,ease:Power3.easeIn}).set(".opinion",{display:"none"}).from(".speech",.3,{alpha:0,ease:Power3.easeOut}).to(".speech",.3,{alpha:0,ease:Power3.easeIn}).set(".speech",{display:"none"}).from(".zhao",.3,{alpha:0,ease:Power3.easeOut},"zhao").add(function(){t(!1)}).add(function(){t(!0)}).to(".zhao .first",.3,{alpha:0,ease:Power3.easeOut},"zhao+=0.5").from(".zhao .video",.3,{alpha:0,ease:Power3.easeOut},"zhao+=0.5").set(".zhao .first",{display:"none"}).to(".zhao .video",.3,{alpha:0,ease:Power3.easeOut}).add(function(){t(!1)}).set(".zhao .video",{display:"none"}).from(".zhao .last",.3,{alpha:0,ease:Power3.easeOut})},p=function(){var e,a=$(".sixnumber .number"),s=$(".qsearch .last .container").innerHeight()-r+200,t=$(".qsearch .post");e=768<i?-1.5*i:-2.75*i,stage3TL=767<i?(new TimelineMax).from(".stage-3",.3,{alpha:0,ease:Power3.easeOut}).to(".analysis",.3,{alpha:0,ease:Power3.easeIn}).set(".analysis",{display:"none"}).from(".qsearch",.3,{alpha:0,ease:Power3.easeOut}).from(".qsearch .first",.3,{alpha:0,ease:Power3.easeOut}).to(".qsearch .first",.3,{alpha:0,ease:Power3.easeIn}).from(".qsearch .last",.3,{alpha:0,ease:Power3.easeOut}).set(t.eq(0),{className:"+=active"},"post").set(t.eq(0),{className:"+=done"},"post+=.3").set(t.eq(1),{className:"+=active"},"post+=.3").set(t.eq(1),{className:"+=done"},"post+=.6").set(t.eq(2),{className:"+=active"},"post+=.6").set(t.eq(2),{className:"+=done"},"post+=.9").set(t.eq(3),{className:"+=active"},"post+=.9").set(t.eq(3),{className:"+=done"},"post+=1.2").set(t.eq(4),{className:"+=active"},"post+=1.2").set(t.eq(4),{className:"+=done"},"post+=1.5").set(t.eq(5),{className:"+=active"},"post+=1.5").set(t.eq(5),{className:"+=done"},"post+=1.8").set(t.eq(6),{className:"+=active"},"post+=1.8").set(t.eq(6),{className:"+=done"},"post+=2.1").set(t.eq(7),{className:"+=active"},"post+=2.1").to(".qsearch",.3,{alpha:0,ease:Power3.easeIn}).set(".qsearch",{display:"none"}).from(".sixnumber",.3,{alpha:0,ease:Power3.easeOut}).from(".sixnumber .first",.3,{alpha:0,ease:Power3.easeOut}).to(".sixnumber .first",.3,{alpha:0,ease:Power3.easeIn}).from(".sixnumber .last",.3,{alpha:0,ease:Power3.easeOut}).to(a.eq(0),.3,{className:"+=active"},"num").to(a.eq(0),.3,{className:"-=active"},"num+=.3").to(a.eq(1),.3,{className:"+=active"},"num+=.3").to(a.eq(1),.3,{className:"-=active"},"num+=.6").to(a.eq(2),.3,{className:"+=active"},"num+=.6").to(a.eq(2),.3,{className:"-=active"},"num+=.9").to(a.eq(3),.3,{className:"+=active"},"num+=.9").to(a.eq(3),.3,{className:"-=active"},"num+=1.2").to(a.eq(4),.3,{className:"+=active"},"num+=1.2").to(a.eq(4),.3,{className:"-=active"},"num+=1.5").to(a.eq(5),.3,{className:"+=active"},"num+=1.5").to(".sixnumber",.3,{alpha:0,ease:Power3.easeIn},"key").to(".stage-3 .party",.3,{alpha:0,ease:Power3.easeIn},"key").set(".sixnumber",{display:"none"}).from(".keyword",.3,{alpha:0,ease:Power3.easeOut}).to(".keyword .before",.3,{alpha:0,ease:Power3.easeIn}).set(".keyword .before",{display:"none"}).from(".keyword .grid",.3,{alpha:0,ease:Power3.easeOut}).to(".keyword .grid .column",1,{x:e,ease:Linear.easeNone}):(new TimelineMax).from(".stage-3",.3,{alpha:0,ease:Power3.easeOut}).to(".analysis",.3,{alpha:0,ease:Power3.easeIn}).set(".analysis",{display:"none"}).from(".qsearch",.3,{alpha:0,ease:Power3.easeOut}).from(".qsearch .first",.3,{alpha:0,ease:Power3.easeOut}).to(".qsearch .first",.3,{alpha:0,ease:Power3.easeIn}).from(".qsearch .last",.3,{alpha:0,ease:Power3.easeOut}).to(".qsearch .last .container",3,{y:-s,ease:Linear.easeNone}).to(".qsearch",.3,{alpha:0,ease:Power3.easeIn}).set(".qsearch",{display:"none"}).from(".sixnumber",.3,{alpha:0,ease:Power3.easeOut}).from(".sixnumber .first",.3,{alpha:0,ease:Power3.easeOut}).to(".sixnumber .first",.3,{alpha:0,ease:Power3.easeIn}).set(".sixnumber .first",{display:"none"}).from(".sixnumber .last",.3,{alpha:0,ease:Power3.easeOut}).to(a.eq(0),.3,{alpha:0,ease:Power3.easeIn}).from(a.eq(1),.3,{alpha:0,ease:Power3.easeOut}).to(a.eq(1),.3,{alpha:0,ease:Power3.easeIn}).from(a.eq(2),.3,{alpha:0,ease:Power3.easeOut}).to(a.eq(2),.3,{alpha:0,ease:Power3.easeIn}).from(a.eq(3),.3,{alpha:0,ease:Power3.easeOut}).to(a.eq(3),.3,{alpha:0,ease:Power3.easeIn}).from(a.eq(4),.3,{alpha:0,ease:Power3.easeOut}).to(a.eq(4),.3,{alpha:0,ease:Power3.easeIn}).from(a.eq(5),.3,{alpha:0,ease:Power3.easeOut}).to(".sixnumber",.3,{alpha:0,ease:Power3.easeIn},"key").to(".stage-3 .party",.3,{alpha:0,ease:Power3.easeIn},"key").set(".sixnumber",{display:"none"}).from(".keyword",.3,{alpha:0,ease:Power3.easeOut})},m=function(e){e?bodyScrollLock.disableBodyScroll(a):bodyScrollLock.enableBodyScroll(a),console.log(e)},w=function(){e(),e(),i=$(window).width(),r=$(window).height(),$(window).on("resize",function(){767<(i=$(window).width())&&location.reload()}),function(){var e=$(".speech .kmt .subtitle li"),a=$(".speech .dpp .subtitle li");hanTL=new TimelineMax({paused:!0}).to(e.eq(0),.3,{height:0,ease:Power3.easeOut},4.42).set(e.eq(1),{className:"+=active"},4.42).to(e.eq(1),.3,{height:0,ease:Power3.easeOut},10.33).set(e.eq(2),{className:"+=active"},10.33).to(e.eq(2),.3,{height:0,ease:Power3.easeOut},13.33).set(e.eq(3),{className:"+=active"},13.33).to(e.eq(3),.3,{height:0,ease:Power3.easeOut},19).set(e.eq(4),{className:"+=active"},19).to(e.eq(4),.3,{height:0,ease:Power3.easeOut},23).set(e.eq(5),{className:"+=active"},23).to(e.eq(5),.3,{height:0,ease:Power3.easeOut},26).add(function(){s(!1),c.pause()},26.5),tsaiTL=new TimelineMax({paused:!0}).to(a.eq(0),.3,{height:0,ease:Power3.easeOut},5.17).set(a.eq(1),{className:"+=active"},5.17).to(a.eq(1),.3,{height:0,ease:Power3.easeOut},10.25).set(a.eq(2),{className:"+=active"},10.25).to(a.eq(2),.3,{height:0,ease:Power3.easeOut},19.33).set(a.eq(3),{className:"+=active"},19.33).to(a.eq(3),.3,{height:0,ease:Power3.easeOut},27.25).set(a.eq(4),{className:"+=active"},27.25).to(a.eq(4),.3,{height:0,ease:Power3.easeOut},33.17).set(a.eq(5),{className:"+=active"},33.17).to(a.eq(5),.3,{height:0,ease:Power3.easeOut},37).add(function(){s(!1),h.pause()},37.5),$(".speech .btn a").on("click",function(){o=$(this).parents(".party"),n=o.siblings();var e=$(this).data("status"),a=$(this).data("source");"play"===e&&(s(!0),"han"===a&&(c.currentTime=0,c.play(),hanTL.restart()),"tsai"===a&&(h.currentTime=0,h.play(),tsaiTL.restart())),"pause"===e&&(s(!1),"han"===a&&(c.pause(),hanTL.stop()),"tsai"===a&&(h.pause(),tsaiTL.stop()))})}(),$(".zhao .video .btn a").on("click",function(){l.muted=!l.muted,l.muted?$(this).addClass("muted"):$(this).removeClass("muted")}),function(){var o,e=$(".election .chart .bar");e.mouseover(function(){o=$(this).find(".tips"),TweenLite.to(o,.2,{scale:1,autoAlpha:1}),e.on("mousemove",function(e){var a=e.target.getBoundingClientRect(),s=e.clientX-a.left,t=e.clientY-a.top;TweenLite.to(o,.1,{x:s,y:t})})}),e.mouseout(function(){TweenLite.to(o,.2,{scale:.5,autoAlpha:0})})}(),u(),p(),controller=new ScrollMagic.Controller,scene=new ScrollMagic.Scene({triggerElement:".stage-1",triggerHook:"onLeave",duration:6*r}).setPin(".stage-1").setTween(stage1TL).addTo(controller),scene=new ScrollMagic.Scene({triggerElement:".stage-3",triggerHook:"onLeave",duration:10*r}).setPin(".stage-3").setTween(stage3TL).addTo(controller),scene=new ScrollMagic.Scene({triggerElement:"#footer",triggerHook:"onEnter"}).setTween(TweenLite.from("#footer .member",.1,{y:75,ease:Linear.easeNone})).addTo(controller),i<767&&(scene=new ScrollMagic.Scene({triggerElement:".end",triggerHook:"onLeave",duration:r}).setPin(".end").setTween(TweenLite.from(".end",.3,{alpha:0,ease:Power3.easeOut})).addTo(controller)),$(".event").each(function(e,a){var s=$(".chart").eq(e),t=s.find(".bar"),o=s.find(".city");scene=new ScrollMagic.Scene({triggerElement:a,triggerHook:"onCenter"}).setTween([TweenLite.from(s,.3,{alpha:0,ease:Power3.easeOut}),TweenLite.from(t,1,{width:"0%",ease:Power3.easeOut}),TweenMax.staggerFrom(o,.3,{scale:2,alpha:0,ease:Power3.easeOut},.03)]).addTo(controller)})};return{init:function(){w()}}}();